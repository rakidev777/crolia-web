...
const agentFeatures = [
  ...
  },
  {
    ...
    description: "Cargamos tu catálogo, precios, FAQ o políticas. El agente responde con información real y actualizada de tu negocio.",
  },
  {
    icon: "🔁",
    title: "Seguimiento automático de leads",
    description: "Si un cliente consultó y no compró, el agente retoma la conversación automáticamente con un mensaje personalizado. Recuperás ventas que de otra forma se pierden.",
  },
  {
    icon: "📊",
    title: "Dashboard de ventas en tiempo real",
    description: "Visualizá consultas, conversiones, productos más consultados y hora pico de actividad. Todo desde un panel propio, sin necesidad de herramientas externas.",
  },
  {
    icon: "🎯",
    title: "Detección de señales de venta",
    description: "El agente identifica cuando un cliente está listo para comprar y actúa en consecuencia: confirma disponibilidad, ofrece métodos de pago y cierra el proceso.",
  },
  {
    icon: "✅",
    title: "Panel de tareas para el equipo",
    description: "Cuando hay algo que necesita intervención humana, el agente crea una tarea automática con todo el contexto. Tu equipo actúa en el momento justo, sin revisar cada chat.",
  },
  {
    icon: "🤝",
    title: "Escalado a colaborador con contexto",
    description: "Si el cliente necesita hablar con una persona, el agente transfiere la conversación con un resumen completo. Tu colaborador entra directo al punto — el cliente no repite nada.",
  },
  {
    icon: "🔌",
    title: "Integraciones a medida",
    description: "Google Calendar, Tiendanube, CRMs y APIs externas. El agente se conecta a los sistemas que ya usás para dar respuestas en tiempo real.",
  },
  {
    icon: "✔️",
      ...
      <header className="sticky top-0 z-30 border-b border-black/6 bg-[color:var(--color-surface-soft)]/85 backdrop-blur-xl">
        <div className="section-shell flex items-center justify-between py-4">
          <a href="#inicio" className="flex items-center gap-3">
            <img src="/crolia-icon-1024.png" alt="Crolia" className="h-14 w-14" />
