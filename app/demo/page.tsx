...
const AGENTS = [
  {
    ...
    context: "Negocio: Barbería El Maestro · Agente: Bruno · Servicios: corte ($7.000), corte+barba ($8.500), barba ($3.500), coloración ($12.000) · Consulta turnos disponibles en Google Calendar",
  },
  {
    id: "ventas",
    icon: "🛒",
  ...
  },
  {
    ...
    welcome: "¡Hola! Soy Tomás de Lo de Carla 🍽️ ¿Querés hacer una reserva o consultar el menú?",
    context: "Negocio: Lo de Carla (parrilla/casera) · Agente: Tomás · Menú con precios cargados · Reservas vía sistema en tiempo real · También delivery por Pedidos Ya y Rappi",
  },
  {
    id: "gimnasio",
    icon: "🏋️",
    ...
    welcome: "¡Hola! Soy Luca de PowerFit Club 🏋️ ¿Querés info sobre membresías o reservar una clase?",
    context: "Negocio: PowerFit Club · Agente: Luca · Membresías desde $13.000/mes · Clases grupales incluidas · Reserva de clases y consulta de membresía para clientes existentes",
  },
  {
    id: "clinica",
    icon: "🏥",
