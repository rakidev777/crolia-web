          ...
          <div>
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              ...
              <div style={{ marginTop: "1.25rem", display: "flex", justifyContent: "center" }}>
                <a
                  href="https://wa.me/5491173729899?text=Hola%20Crolia%2C%20quiero%20saber%20más%20sobre%20los%20agentes%20de%20IA"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#25d366", color: "white", fontWeight: 600, fontSize: "0.9rem", padding: "0.65rem 1.4rem", borderRadius: "999px", textDecoration: "none", boxShadow: "0 2px 12px rgba(37,211,102,0.3)" }}
                >
          ...
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.6)", margin: "0 0 1.25rem" }}>
                Contanos más sobre tu negocio, ideas y objetivos para armar una solución ajustada a tus necesidades. En pocos días ya contarás con la solución implementada.
              </p>
              <a
              ...
              >
                ...
                Hablar con el equipo de Crolia por WhatsApp
              </a>
            </div>
          </div>
        )}
